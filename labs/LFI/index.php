...
// Local File Inclusion (LFI) Labs Data - Vulnerability-focused progression
$labs = [
  [
    'id' => 1,
    'name' => 'Local File Inclusion Case 1 - Basic',
    'file' => 'Labs/LFI-CASE1.php',
    'description' => 'Unvalidated file inclusion via path parameter. Exploit naive include() and require() calls by injecting relative path sequences to read sensitive local files like /etc/passwd or application source code.',
    'difficulty' => 'Easy',
    'icon' => '📂',
    'color' => 'orange',
    'tags' => ['Include', 'Path Traversal', 'Basic', 'File Read'],
    'completed' => false
  ],
  [
    'id' => 2,
    'name' => 'Local File Inclusion Case 2 - Filter Bypass',
    'file' => 'Labs/LFI-CASE2.php',
    'description' => 'Weak input sanitization and blacklist bypasses. Abuse null byte injection, double encoding, Unicode normalization, or path truncation to evade naive filters and access restricted files.',
    'difficulty' => 'Medium',
    'icon' => '🛡️',
    'color' => 'coral',
    'tags' => ['Null Byte', 'Encoding', 'Bypass', 'Truncation'],
    'completed' => false
  ],
  [
    'id' => 3,
    'name' => 'Local File Inclusion Case 3 - Log Poisoning',
    'file' => 'Labs/LFI-CASE3.php',
    'description' => 'Log file and session poisoning for code execution. Inject malicious payloads into web server logs, user-agent headers, or session files, then include them to achieve arbitrary PHP code execution.',
    'difficulty' => 'Medium',
    'icon' => '🧪',
    'color' => 'coral',
    'tags' => ['Log Poisoning', 'Session File', 'RCE', 'Code Execution'],
    'completed' => false
  ],
  [
    'id' => 4,
    'name' => 'Local File Inclusion Case 4 - Advanced Chain',
    'file' => 'Labs/LFI-CASE4.php',
    'description' => 'Complex file inclusion chains combining PHP wrappers, file upload abuse, and SSRF. Leverage php://filter, data://, and zip:// wrappers to bypass restrictions and achieve full server compromise.',
    'difficulty' => 'Hard',
    'icon' => '🔗',
    'color' => 'crimson',
    'tags' => ['PHP Wrappers', 'File Upload', 'SSRF', 'Full RCE'],
    'completed' => false
  ]
];
...
<head>
  ...
  <title>Local File Inclusion Training Labs | DarkHunter</title>
  <link
  ...
  <link rel="stylesheet" type="text/css" href="/DarkHunter/labs/LFI/css/index.css">
...
<body>
  ...
  <div class="container">
    ...
    <div class="header">
      ...
      <h1>Local File Inclusion Labs</h1>
      <p>Master file inclusion vulnerabilities and path traversal exploitation. From basic directory traversal to
        advanced log poisoning and PHP wrapper abuse that transforms file reads into full remote code execution.</p>
