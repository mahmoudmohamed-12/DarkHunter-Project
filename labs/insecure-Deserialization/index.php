...
// Insecure Deserialization Labs Data - Vulnerability-focused progression
$labs = [
  [
    'id' => 1,
    'name' => 'Insecure Deserialization Case 1 - Basic',
    'file' => 'Labs/INSECURE-DESERIALIZATION-CASE1.php',
    'description' => 'Unvalidated object deserialization. Exploit naive unserialize() calls by injecting malicious serialized payloads to tamper with object properties and alter application logic.',
    'difficulty' => 'Easy',
    'icon' => '📦',
    'color' => 'orange',
    'tags' => ['Unserialize', 'Object Injection', 'Basic', 'Property Tampering'],
    'completed' => false
  ],
  [
    'id' => 2,
    'name' => 'Insecure Deserialization Case 2 - POP Chain',
    'file' => 'Labs/INSECURE-DESERIALIZATION-CASE2.php',
    'description' => 'Property-Oriented Programming chain. Leverage existing magic methods (__wakeup, __destruct) to construct multi-step gadget chains for arbitrary code execution.',
    'difficulty' => 'Medium',
    'icon' => '🔗',
    'color' => 'coral',
    'tags' => ['POP Chain', 'Magic Methods', 'Gadgets', 'RCE'],
    'completed' => false
  ],
  [
    'id' => 3,
    'name' => 'Insecure Deserialization Case 3 - Custom Protocol',
    'file' => 'Labs/INSECURE-DESERIALIZATION-CASE3.php',
    'description' => 'Custom serialization formats and wrappers. Abuse phar://, zip://, or custom stream wrappers to trigger deserialization in unexpected contexts and bypass filters.',
    'difficulty' => 'Medium',
    'icon' => '⚡',
    'color' => 'coral',
    'tags' => ['Phar', 'Stream Wrappers', 'File Upload', 'Wrapper Abuse'],
    'completed' => false
  ],
  [
    'id' => 4,
    'name' => 'Insecure Deserialization Case 4 - Advanced RCE',
    'file' => 'Labs/INSECURE-DESERIALIZATION-CASE4.php',
    'description' => 'Complex deserialization chains combining SSRF, file write primitives, and memory corruption. Advanced multi-step exploitation leading to full server compromise.',
    'difficulty' => 'Hard',
    'icon' => '💣',
    'color' => 'crimson',
    'tags' => ['SSRF', 'File Write', 'Memory Corruption', 'Full RCE'],
    'completed' => false
  ]
];
...
<head>
  ...
  <title>Insecure Deserialization Training Labs | DarkHunter</title>
  <link
  ...
  <link rel="stylesheet" type="text/css" href="/DarkHunter/labs/Insecure-Deserialization/css/index.css">
</head>
...
<body>
  ...
  <div class="container">
    ...
    <div class="header">
      ...
      <p>Master object injection attacks and deserialization exploitation. From basic property tampering to advanced POP
        chains and gadget-based remote code execution that compromise entire systems.</p>
