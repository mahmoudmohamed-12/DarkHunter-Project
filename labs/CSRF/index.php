...
[
  'id' => 1,
  'name' => 'CSRF Case 1 - Basic Form',
  'file' => 'Labs/CSRF-CASE1.php',
  'description' => 'No CSRF token protection on state-changing forms. Submit unauthorized requests from attacker-controlled pages to modify victim data.',
  'difficulty' => 'Easy',
  'icon' => '📝',
  'color' => 'orange',
  'tags' => ['No Token', 'Form Submit', 'Basic', 'State Change'],
  'completed' => false
],
[
  'id' => 2,
  'name' => 'CSRF Case 2 - GET Based',
  'file' => 'Labs/CSRF-CASE2.php',
  'description' => 'State-changing actions via GET requests. Exploit predictable URLs to perform unauthorized actions through image tags or links.',
  'difficulty' => 'Easy',
  'icon' => '🔗',
  'color' => 'orange',
  'tags' => ['GET Request', 'URL Based', 'Image Tag', 'Link'],
  'completed' => false
],
[
  'id' => 3,
  'name' => 'CSRF Case 3 - Weak Token',
  'file' => 'Labs/CSRF-CASE3.php',
  'description' => 'Predictable or weak CSRF tokens. Guess tokens through patterns, brute force short tokens, or exploit token generation flaws.',
  'difficulty' => 'Medium',
  'icon' => '🔑',
  'color' => 'coral',
  'tags' => ['Weak Token', 'Predictable', 'Brute Force', 'Pattern'],
  'completed' => false
],
[
  'id' => 4,
  'name' => 'CSRF Case 4 - Token Reuse',
  'file' => 'Labs/CSRF-CASE4.php',
  'description' => 'Non-expiring or reusable CSRF tokens. Capture valid tokens and replay them across sessions or different endpoints.',
  'difficulty' => 'Medium',
  'icon' => '🔄',
  'color' => 'coral',
  'tags' => ['Token Reuse', 'Non-Expiring', 'Replay', 'Session'],
  'completed' => false
],
[
  'id' => 5,
  'name' => 'CSRF Case 5 - SameSite Bypass',
  'file' => 'Labs/CSRF-CASE5.php',
  'description' => 'Bypass SameSite cookie restrictions. Exploit Lax/None configurations or chain with XSS to perform cross-site requests.',
  'difficulty' => 'Hard',
  'icon' => '🍪',
  'color' => 'crimson',
  'tags' => ['SameSite', 'Cookie', 'Lax/None', 'XSS Chain'],
  'completed' => false
],
[
  'id' => 6,
  'name' => 'CSRF Case 6 - JSON/XML Request',
  'file' => 'Labs/CSRF-CASE6.php',
  'description' => 'CSRF against API endpoints. Abuse CORS misconfigurations or content-type tricks to send forged JSON/XML requests.',
  'difficulty' => 'Hard',
  'icon' => '📡',
  'color' => 'crimson',
  'tags' => ['API', 'JSON', 'XML', 'Content-Type'],
  'completed' => false
],
[
  'id' => 7,
  'name' => 'CSRF Case 7 - Double Submit',
  'file' => 'Labs/CSRF-CASE7.php',
  'description' => 'Break double-submit cookie pattern. Manipulate cookie and parameter values independently to bypass validation.',
  'difficulty' => 'Hard',
  'icon' => '🎭',
  'color' => 'crimson',
  'tags' => ['Double Submit', 'Cookie', 'Parameter', 'Bypass'],
  'completed' => false
],
[
  'id' => 8,
  'name' => 'CSRF Case 8 - Multi-Step Chain',
  'file' => 'Labs/CSRF-CASE8.php',
  'description' => 'Complex multi-step CSRF chain. Combine with XSS, open redirect, and session fixation to achieve full account takeover.',
  'difficulty' => 'Hard',
  'icon' => '⛓️',
  'color' => 'crimson',
  'tags' => ['Multi-Step', 'Chain', 'Account Takeover', 'Advanced'],
  'completed' => false
]
];
...
<head>
  ...
  <title>CSRF Training Labs | DarkHunter</title>
  <link
  ...
  <link rel="stylesheet" type="text/css" href="/DarkHunter/labs/CSRF/css/index.css">
</head>
...
<body>
  ...
  <div class="container">
    ...
    <div class="header">
      ...
      <h1>CSRF Labs</h1>
      <p>Master Cross-Site Request Forgery vulnerabilities. From basic unprotected forms to advanced SameSite bypasses,
        token manipulation, and multi-step attack chains.</p>
