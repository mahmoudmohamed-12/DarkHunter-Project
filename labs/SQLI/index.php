...
// SQL Injection Labs Data
$labs = [
  [
    'id' => 1,
    'name' => 'SQLI Case 1 - Basic Injection',
    'file' => 'Labs/SQLI-Case1.php',
    'description' => 'Classic UNION-based SQL injection in login forms. Extract data via crafted payloads using single quotes and basic comment bypass.',
    'difficulty' => 'Easy',
    'icon' => '💉',
    'color' => 'teal',
    'tags' => ['UNION', 'Login Bypass', 'Error Based', 'Classic'],
    'completed' => false
  ],
  [
    'id' => 2,
    'name' => 'SQLI Case 2 - Blind Injection',
    'file' => 'Labs/SQLI-Case2.php',
    'description' => 'Time-based and boolean-based blind SQLi. Extract data bit-by-bit using conditional delays and response analysis without error messages.',
    'difficulty' => 'Medium',
    'icon' => '👁️',
    'color' => 'violet',
    'tags' => ['Blind', 'Time-Based', 'Boolean', 'Heavy Queries'],
    'completed' => false
  ],
  [
    'id' => 3,
    'name' => 'SQLI Case 3 - Advanced Bypass',
    'file' => 'Labs/SQLI-Case3.php',
    'description' => 'WAF evasion and stacked queries. Bypass filters using encoding, comment injection, and out-of-band data exfiltration techniques.',
    'difficulty' => 'Hard',
    'icon' => '🧬',
    'color' => 'rose',
    'tags' => ['WAF Bypass', 'Stacked', 'OOB', 'Filter Evasion'],
    'completed' => false
  ]
];
...
<head>
  ...
  <title>SQL Injection Training Labs | DarkHunter</title>
  <link rel="stylesheet" type="text/css" href="/DarkHunter/labs/SQLI/css/index.css">
  <link
...
<body>
  ...
  <div class="container">
    <!-- Header with Database Core Effect -->
    <div class="header">
      <div class="page-logo">
      ...
      <p>Master database exploitation from classic UNION attacks to advanced blind injection and WAF bypass techniques.
        Manipulate queries and extract data.</p>
  ...
  function createDataStream() {
    ...
    for (let i = 0; i < 15; i++) {
      ...
      stream.style.left = (i * 7 + Math.random() * 3) + '%';
      stream.style.animationDuration = (4 + Math.random() * 6) + 's';
  ...
  function createParticles() {
    ...
    const colors = ['#2dd4bf', '#8b5cf6', '#f43f5e', '#14b8a6', '#a78bfa'];
